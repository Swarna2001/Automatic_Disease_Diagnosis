...
max_turn = 22
file0 = '/content/drive/MyDrive/Task_DS_HRL/src/classifier/data/Fudan-Medical-Dialogue2/synthetic_dataset'
#file0='./../../data/simulated/label_all'
...
parser.add_argument("--label_all_model_path", dest="label_all_model_path", type=str, default='/content/drive/MyDrive/Negative_Report/data/best_models_reduced')
